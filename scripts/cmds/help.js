...
module.exports = { 
  ...
  langs: { 
    ...
    en: { 
      ...
      help: "Error occurred: Type: %5sorthelp category — To view all command available.", 



      help2: "%1╰─╼━━━━━━━━╾─⭔\n╭──━━━━━━━━━╾⭔\n│» Currently, the bot\n│has %2 commands\n├──━━━━━━━━━╾⭔\n│» Type {p}𝗵𝗲𝗹𝗽 <command\n│name> to view the details of\n│how to use that command\n│%4\n╰──━━━━━━━━━╾⭓", 
    ...
    if (!command && !args[0] || !isNaN(args[0])) { 
      ...
      if (sortHelp == "name") { 
        ...
        arrayInfo.forEach((data, index) => { 
          ...
          const categoryUpcase = `${index == 0 ? `╭` : `╰`}─╼━━━━━━━━╾${index == 0 ? "⭓" : "⭔"}\n╭──━━『${data.category.toUpperCase()}』`; 
